...
var EXP = (function () {
    // ***** 必須の変数・定数
    var TITLE = "muller-lyer_between";  // 結果データを保存するディレクトリ名に使われる
    ...
    var prologue2 = function () {
        ...
        IO.display_instruction("【Muller-Lyer錯視】",
                               [["左右の直線が同じ長さになるようボタンをクリックして調整し，その後確認ボタンを押してください。", "center"]],
                               ID_MAIN);
        block_prologue();
    };
    ...
    var do_first_trial = function () {
        var set_screen = function () {
            ...
            str = "<p>左右の直線が同じ長さになるようボタンをクリックして調節し、" +
                "その後確認ボタンを押してください。</p>" +
    ...
    var confirm = function () {
        ...
        canvas.moveTo(335,100);
        canvas.lineTo(335,300);
        canvas.stroke();
